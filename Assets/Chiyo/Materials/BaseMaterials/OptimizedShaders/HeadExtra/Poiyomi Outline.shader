Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi Outline/f289e6669a3b396429903f971a7a07fe"
{
	Properties
	{
 ...
 #define PROP_EMISSIONMAP 
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = float(3.88);
				float3 emissionColor0 = 0;
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark(float(0), float(1), float(0.043), float(0), float(1), float(0), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
				if (!float(0))
				{
